...
% second segment goes from 0.25 to 0.55
for i = round(0.25*8000) + 1:round(0.55*8000)
    % formula for second segment
    xx(i) = cos(2*pi*880*i / 8000);
end
% third segment goes from 0.55 to 0.85
for i = round(0.55*8000) + 1:round(0.85*8000)
